...
public class AdvanceMovement : MonoBehaviour
{
    ...
    {
        if (TutorialManager.instance.basicMoveUIObj.activeSelf && Input.GetKeyDown(KeyCode.Space) && TutorialManager.instance.basicMoveUI[TutorialManager.instance.objectivesComplete].color != Color.green)
        {
            TutorialManager.instance.advanceMoveUI[0].color = Color.green;
            TutorialManager.instance.objectivesComplete++;
        }
        else if (TutorialManager.instance.basicMoveUIObj.activeSelf && Input.GetKeyDown(KeyCode.LeftShift) && TutorialManager.instance.basicMoveUI[TutorialManager.instance.objectivesComplete].color != Color.green)
        {
            TutorialManager.instance.advanceMoveUI[1].color = Color.green;
            TutorialManager.instance.objectivesComplete++;
        }
        else if (TutorialManager.instance.basicMoveUIObj.activeSelf && Input.GetKeyDown(KeyCode.LeftControl) && TutorialManager.instance.basicMoveUI[TutorialManager.instance.objectivesComplete].color != Color.green)
        {
