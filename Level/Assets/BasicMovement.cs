...
public class BasicMovement : MonoBehaviour
{
    ...
    {
        if(TutorialManager.instance.basicMoveUIObj.activeSelf && Input.GetKeyDown(KeyCode.W))
        {
            TutorialManager.instance.basicMoveUI[0].color = Color.green;
            TutorialManager.instance.objectivesComplete++;
        }
        else if (TutorialManager.instance.basicMoveUIObj.activeSelf && Input.GetKeyDown(KeyCode.A))
        {
            TutorialManager.instance.basicMoveUI[1].color = Color.green;
            TutorialManager.instance.objectivesComplete++;
        }
        else if (TutorialManager.instance.basicMoveUIObj.activeSelf && Input.GetKeyDown(KeyCode.S))
        {
            TutorialManager.instance.basicMoveUI[2].color = Color.green;
            TutorialManager.instance.objectivesComplete++;
        }
        else if (TutorialManager.instance.basicMoveUIObj.activeSelf && Input.GetKeyDown(KeyCode.D))
        {
